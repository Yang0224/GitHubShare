...
@EnableJpaRepositories(basePackages = "com.miracle.frame.orm.dao")   //注解开启对Spring Data JPA Repostory的支持
@EntityScan(basePackages = "com.miracle.frame.orm.entity")      //对实体类的扫描
